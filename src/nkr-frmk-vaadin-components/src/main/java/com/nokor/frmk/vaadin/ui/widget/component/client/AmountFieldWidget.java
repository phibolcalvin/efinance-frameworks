 ...
 * @author ky.nora
 */
public class AmountFieldWidget extends VTextField implements KeyPressHandler, BlurHandler {
	...
	private boolean isAcceptedKey(char charCode) {
		...
		if (charCode == '-' && getText().charAt(0) != '-' && getCursorPos() == 0)
			return true;
