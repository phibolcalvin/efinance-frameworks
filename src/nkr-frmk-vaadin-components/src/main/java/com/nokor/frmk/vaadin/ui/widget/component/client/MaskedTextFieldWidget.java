...
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.AlphanumericMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.HexMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.LetterMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.LowerCaseMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.Mask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.NumberMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.SignMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.UpperCaseMask;
import com.nokor.frmk.vaadin.ui.widget.component.client.mask.WildcardMask;
...
public class MaskedTextFieldWidget extends VTextField implements KeyDownHandler,
	...
	private void createCorrectMaskAndPlaceholder(char character, int index) {
		...
		case '\'':
			...
			break;
		case '#':
			addMaskStrategyAndCharacterPlaceHolder(new NumberMask(),placeholder);
			break;
		case 'U':
	...
	public void onFocus(FocusEvent event) {
		if (getText().isEmpty()) {
            ...
            // chrome bugged on focus and click, remove timer after chrome fixed it.
            (new Timer() {
                   @Override
                   public void run() {
                       setCursorPos(getAvaliableCursorPos(0));
